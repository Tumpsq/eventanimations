...
const SpinnerUploader = () => {
  ...
  return (
    <div
      className="Spinner-uploader-container"
      onClick={() => handleClick()}
      style={{ pointerEvents: `${state !== 0 ? "none" : "all"}` }}
    >
      <div className="Spinner-uploader-circle">
        <div
          className="Spinner-loader-ball-container"
          style={{ animation: `${state === 1 && "spin 1s linear infinite"}` }}
        >
          <div
            className="Spinner-loader-ball"
            style={{
              animationName: `${
                state === 1
                  ? "spinner-loader-ball-shrink"
                  : "spinner-loader-ball-grow"
              }`
            }}
          />
        </div>
        ...
        <div
          className="Spinner-loader-action Spinnner-uploader-percentage"
